...
export function CREDIcon(props: IconProps) {
  return (
...
export function MeeshoIcon(props: IconProps) {
  return (
...
export function SwiggyIcon(props: IconProps) {
  return (
...
export function ZerodhaIcon(props: IconProps) {
  return (
...
interface StartupLogo {
  name: string;
  id: number;
  img: React.FC<IconProps>;
}

export const startupLogos: StartupLogo[] = [
